...
// import EmployeeForm from '../(tenant)/components/EmployeeForm'; // Import the EmployeeForm
// import SalarySetupForm from '../(tenant)/components/SalarySetupForm'; // Import the SalarySetupForm
// import SalaryComponentSetup from '../(tenant)/components/SalaryComponentSetup'; // Import the SalaryComponentSetup
// import LeaveListDisplay from '../(tenant)/components/LeaveListDisplay'; // Import the LeaveListDisplay
// import LeaveRequestForm from '../(tenant)/components/LeaveRequestForm'; // Import the LeaveRequestForm
// import PayrollBreakdown from '../(tenant)/components/PayrollBreakdown'; // Import the PayrollBreakdown
// import DocumentUploadModal from '../(tenant)/components/DocumentUploadModal'; // Import the DocumentUploadModal
...
// 				fetch(`${baseURL}/api/tenant/payroll-settings/salary-components`, {
// 					method: 'GET',
// 					headers: {
...
//                       <DetailField label="First Name" value={'employee.first_name || 0'} />
//                       <DetailField label="Last Name" value={'employee.last_name || 0'} />
...
//                 //   <PayrollBreakdown
//                 //     employee={employee}
//                 //     // onProcessPayroll={handleProcessPayroll || null}
