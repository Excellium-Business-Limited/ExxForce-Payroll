...
const Page = () => {
  ...
  return (
    <div className='flex-1 flex flex-col h-[calc(100vh-64px)] overflow-auto'>
          ...
          <div className='flex gap-3 w-full md:w-auto'>
            <Sheet>
              ...
              <SheetContent className='min-w-[500px] p-4 overflow-auto bg-white'>
                ...
                <EmployeeForm employeeData={null} isEdit={false} />
              </SheetContent>
            </Sheet>
            <Button
              size='lg'
      ...
      {/* Hidden Sheet for Edit Mode */}
      <Sheet open={isEdit} onOpenChange={setIsEdit}>
        <SheetContent className='min-w-[500px] p-4 overflow-auto bg-white'>
          <SheetTitle className='hidden'></SheetTitle>
          <EmployeeForm employeeData={employeeData} isEdit={true} />
        </SheetContent>
      </Sheet>
    </div>
  );
